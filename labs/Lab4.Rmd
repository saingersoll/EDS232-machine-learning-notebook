...
> The confusion matrix is articulating the count of True (+) ['Reference 1'] and False (+) ['Prediction 1'] for the model predictions. Additionally, it includes the count of True (-) ['Reference 0'] and False (-) ['Prediction 0'].
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#test_predict %>% 
 # conf_mat(truth = yr1status,
  #         estimate = .pred_class) %>% #create confusion matrix
  #autoplot(type = "heatmap") + #plot confusion matrix with heatmap
  #theme_bw() + #change theme
  #theme(axis.text.x = element_text(angle = 30,
   #                                hjust=1)) #rotate axis labels
