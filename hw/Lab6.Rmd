...
xgb_spec_tune <- boost_tree(learn_rate = best_learn,
                            ...
                            tree_depth =best_grid$tree_depth,
                            min_n = best_grid$min_n,
                            loss_reduction = best_grid$loss_reduction,
...
xgb_best <- show_best(xgb_cv_tune, n = 1, metric = "accuracu") # get metrics for best xgb model
