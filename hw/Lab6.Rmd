...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# add lect 6 params
xgb_lhc_grid <- grid_latin_hypercube(learn_rate = best_learn,
                                 #    trees = tune(),
                                     resamples = cv_folds,
                                     grid = 10)
...
# ----                     Collect Metrics                                  ----
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
collect_metrics(xgb_lhc_tune) # get metrics from tuning cv to pick best model

autoplot(xgb_lhc_tune) +      # plot cv results for parameter tuning
  theme_bw()

best_learn <- select_best(xgb_tune)
```
...
xgb_cv_tune = xgb_workflow_tune %>%
  grid_latin_hypercube(lean_rate = tune(), #mry
                       resamples = cv_folds,
                       grid = 10) 
...
xgb_accuracy <- accuracy(test_predict_xgb, truth = Angaus, estimate = .pred_class) 
